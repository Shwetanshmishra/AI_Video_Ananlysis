...
Logic is unchanged from the original utils/audio_processor.py — only the
download directory now comes from backend.config so the whole backend
shares one place for path configuration.
"""
...
def process_input(source: str) -> list:
    if source.startswith("http://") or source.startswith("https://"):
        ...
        print("Detectd local file. Converting to WAV...")
